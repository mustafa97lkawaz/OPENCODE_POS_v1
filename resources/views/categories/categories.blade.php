            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">اضافة تصنيف</h5>
...
@section('js')
    ...
    <script>
        $('#edit_Product').on('show.bs.modal', function(event) {
            ...
            modal.find('#editForm').attr('action', '{{ route("categories.index") }}/' + id);
        })
        ...
        $('#modaldemo9').on('show.bs.modal', function(event) {
            ...
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #Category_name').val(Category_name);
            modal.find('#deleteForm').attr('action', '{{ route("categories.index") }}/' + id);
        })
    </script>
@endsection
