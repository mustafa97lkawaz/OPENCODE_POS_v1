        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="nav-item full-screen fullscreen-button">
                    <a class="new nav-link" href="{{ route('pos.fullscreen') }}" target="_blank" title="فتح POS في نافذة كاملة">
                ...
                <div class="nav-item full-screen fullscreen-button">
                    <a class="new nav-link full-screen-link" href="#" onclick="toggleFullScreen()" title="ملء الشاشة">
