                    ...
                    <form action="{{ route('suppliers.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="Supplier_name" required placeholder="ادخل اسم المورد">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="company_name" placeholder="ادخل اسم الشركة">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="contact_person" placeholder="ادخل اسم شخص الاتصال">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" placeholder="ادخل البريد الإلكتروني">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="balance" value="0" min="0" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>ملاحظات</label>
                                    <textarea class="form-control" name="notes" rows="4" placeholder="ملاحظات اضافية"></textarea>
                                </div>
                            </div>
                        </div>
